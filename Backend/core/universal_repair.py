...
# Add Backend/core to path for relative imports
backend_core = os.path.dirname(os.path.abspath(__file__))
if backend_core not in sys.path:
    sys.path.insert(0, backend_core)

from multi_language_sandbox import compile_and_run
from cpp_patch_generator import generate_cpp_patches
from java_patch_generator import generate_java_patches
from js_patch_generator import generate_js_patches
